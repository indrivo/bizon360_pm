...
namespace Gear.Localizer.Extensions
{
    ...
    {
        public static LocalizedString GetForLanguage(this IStringLocalizer localizer, string key,
            string languageIdentifier)
        {
            return localizer.WithCulture(new CultureInfo(languageIdentifier)).GetString(key);
        }

        public static IEnumerable<LocalizedString> GetAllForLanguage(this IStringLocalizer localizer,
            string languageIdentifier)
        {
