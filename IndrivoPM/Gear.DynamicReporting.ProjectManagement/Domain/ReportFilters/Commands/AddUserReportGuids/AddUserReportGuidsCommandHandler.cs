...
{
    public class AddUserReportGuidsCommandHandler : IRequestHandler<AddUserReportGuidsCommand<Guid>>
    {
        private readonly IGearContext _context;

        public AddUserReportGuidsCommandHandler(IGearContext context)
        {
            _context = context;
        }

        public async Task<Unit> Handle(AddUserReportGuidsCommand<Guid> request, CancellationToken cancellationToken)
        {
