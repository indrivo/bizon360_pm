...
{
    public class ActivateUserReportHeaderCommandHandler : IRequestHandler<ActivateUserReportHeaderCommand<Guid>>
    {
        ...
        public async Task<Unit> Handle(ActivateUserReportHeaderCommand<Guid> request, CancellationToken cancellationToken)
        {
