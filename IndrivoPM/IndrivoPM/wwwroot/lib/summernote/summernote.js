...
(function (global, factory) {
  ...
  var palette = renderer.create('<div class="note-color-palette"/>', function ($node, options) {
    ...
    var dialog = renderer.create('<div class="modal fade"  aria-hidden="true"  role="dialog"/>', function ($node, options) {
      if (options.fade) {
          $node.addClass('fade');
      }
      $node.attr({
      ...
      $node.html([
          ...
          (options.title
              ...
              '      <h6 class="mb-0" id="regular-modal-label">' + options.title + '</h6>' +
  ...
  var LinkDialog = /** @class */ (function () {
      ...
      LinkDialog.prototype.initialize = function () {
          ...
          var body = [
              ...
              "<label class=\"note-form-label float-label\">" + this.lang.link.textToDisplay + "</label>",
              '<input class="note-link-text form-control note-form-control note-input" type="text" />',
              '</div>',
              '<div class="form-group note-form-group">',
              "<label class=\"note-form-label float-label\">" + this.lang.link.url + "</label>",
              '<input class="note-link-url form-control note-form-control note-input" type="text" value="http://" />',
              '</div>',
              `<div class="custom-control custom-checkbox sn-checkbox-open-in-new-window">
                    <input type="checkbox" class="custom-control-input" role="checkbox" id="custom-checkbox" checked />
                    <label class="custom-control-label" for="custom-checkbox">` + this.lang.link.openInNewWindow + `</label>
                </div>`
          ].join('');

          var buttonClass = 'btn btn-success note-btn note-btn-primary note-link-btn';
          var footer = `<button type="button" class="btn btn-outline-secondary" data-dismiss="modal">Close</button>` +
